...
<TR>
  <TD id=eHeader>
   <SPAN class="sys-font-heading3 sys-rhp-color-title sys-rhp-font-title">Help and Support Suggestions</span>
  </TD>
  <TD id=loc1 align="right">
   <IMG id=noloc src="hcp://system/images/centers/Uabrand.gif">
  </TD>
</TR>
</TABLE>

<DIV id="eContainer" style="overflow-y:auto; height:300px;">
  The terms you search for (your "query") are matched against terms that the author of a document defines as "keywords" for that particular document. The results you see from this search are of the highest possible relevance. 
</DIV>
