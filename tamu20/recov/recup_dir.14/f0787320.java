- It is not necessary to localize this text - it will be dynamically loaded from the XML file at runtime -->
		<title>Mises à jour de sécurité post-installation pour Windows Server</title>
		...
		<script language="jscript" type="text/Jscript">
			function onLoad()
			{
				...
				confirmText.innerText = options.message;
				buttonYes.innerText = options.yesText;
				buttonYes.accessKey = options.yesAccessKey;
				buttonNo.innerText = options.noText;
				buttonNo.accessKey = options.noAccessKey;
				buttonNo.focus();
...
PA<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
	<head>
