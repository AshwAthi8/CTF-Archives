...
;
; Sample of how to invoke from oem inf to install bthmodem
;

; [BthModem1_xp.nt]
; include=mdmbtmdm.inf
; needs=mdmbtmdm.BTHMODEM.CopyFiles
; AddReg=All, MfgAddReg

; [BthModem1_xp.nt.Services]
; include=mdmbtmdm.inf
; needs=mdmbtmdm.BTHMODEM.AddService

; [BthModem1_xp.nt.hw]
; include=mdmbtmdm.inf
; needs=mdmbtmdm.BTHMODEM.LowerFilterAddReg
