ll/RT_STRING/#2122'
                        val 'accKeyboardShortcut' = s 'res://wmploc.dll/RT_STRING/#2123'
                    }
                    
                    ForceRemove NextButton
                    {
                        val 'classid' = s 'clsid:87291B51-0C8E-11D3-BB2A-00A0C93CA73A'
                        val 'enabled' = s 'wmpenabled:player.controls.next'
                        val 'upToolTip' = s 'res://wmploc.dll/RT_STRING/#1806'
                        val 'onclick'= s 'player.controls.Next()'
