...
HKLM,"%SMWCV%\Control Panel\Extended Properties\%SCID_CONTROLPANELCATEGORY%","%11%\bthprops.cpl",,"2,3"
...
HKLM,"%SMWCV%\Control Panel\Extended Properties\%SCID_CONTROLPANELCATEGORY%","%11%\inetcpl.cpl",,"3,10"
...
HKLM,"%SMWCV%\Control Panel\Extended Properties\%SCID_CONTROLPANELCATEGORY%","%11%\sysdm.cpl",,"5"
...
HKLM,"%PATH_AUTOPLAY%\EventHandlers\AutorunINFLegacyArrival","MSOpenFolder",,""
...
HKCR,".dvr-ms","PerceivedType",,"video"
...
[RegWow6432Stuff]
HKLM,"%PATH_EXPLORER%\ControlPanel\NameSpace\%CLSID_X86ControlPanelItems%",,,"x86 Control Panel"
HKCR,"CLSID\%CLSID_X86ControlPanelItems%","LocalizedString",,"@shell32.dll,-32188"
HKCR,"CLSID\%CLSID_X86ControlPanelItems%","Infotip",,"@shell32.dll,-32189"
HKCR,"CLSID\%CLSID_X86ControlPanelItems%","%SCID_CONTROLPANELCATEGORY%",%REGDW%,0
HKCR,"CLSID\%CLSID_X86ControlPanelItems%","DefaultIcon",,"shell32.dll,-137"
HKCR,"CLSID\%CLSID_X86ControlPanelItems%\Shell\explore\command",,%REGEXSZ%,"%SystemRoot%\SysWOW64\explorer.exe /e, /separate, /root, ::%CLSID_MyComputer%\::%CLSID_ControlPanel%"
HKCR,"CLSID\%CLSID_X86ControlPanelItems%\Shell\open\command",,%REGEXSZ%,"%SystemRoot%\SysWOW64\explorer.exe /separate, /root, ::%CLSID_MyComputer%\::%CLSID_ControlPanel%"
[RegShellNTPro]
...
CLSID_X86ControlPanelItems = "{09F581A3-1F64-4E5B-8DB3-88F5593080CC}"
