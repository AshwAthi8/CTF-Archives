    ...
    <br><br>
    <span class="title"><ID id=Pberr_s1>Unable to complete online processing</ID></span>

    <br>
    <span class="text-primary" id="pberr_par1"><ID id=Pberr_s2></id></span>


    <br><br>
    <span class="text-primary"><ID id=Pberr_s3>To continue, click <b>Back</b>.</id></span>
