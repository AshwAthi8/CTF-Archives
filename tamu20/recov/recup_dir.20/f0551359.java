; Windows Modem Setup File for MC-P200,MC-P210 TD
; Manufacturer: SII
; Revision: 2.01
; Last Modif: 00/11/20 .Fu
...
[Models.NTamd64]
%Modem1% = Modem1, PCMCIA\SII-PHS_LINK_64-861B				; MC-P200
%Modem2% = Modem2, PCMCIA\SII-PHS_MC-P210/TD-1AD5			; MC-P210

[Strings]
MSFT= "Microsoft"
Mfg = "SII"
Modem1 = "SII PHS LINK 64"
Modem2 = "SII PHS MC-P210 TD"

[Modem1]	; MC-P200
AddReg=All, MfgAddReg, Mdm.AddReg, EXT_Over384.AddReg, ATattR.AddReg , Shrimp.AddReg, PCMCIA
...
[Shrimp.AddReg] ; MC-P200 , MC-P210 TD
...
HKR, Responses, "16<cr>", 1, 02, 02, 00,4b,00,00, 00,00,00,00 ; connect at 19200
HKR, Responses, "17<cr>", 1, 02, 02, 00,96,00,00, 00,00,00,00 ; connect at 38400
...
HKR, Responses, "30<cr>", 1, 02, 02, 00,4b,00,00, 00,00,00,00 ; connect at 19200 with PROC.
HKR, Responses, "31<cr>", 1, 02, 02, 00,96,00,00, 00,00,00,00 ; connect at 38400 with PROC.
...
[EXT_Over384.AddReg]
HKR, Responses, "18<cr>", 1, 02, 02, 00,E1,00,00, 00,00,00,00 ; connect at 57600
HKR, Responses, "19<cr>", 1, 02, 02, 00,C2,01,00, 00,00,00,00 ; connect at 115200
HKR, Responses, "32<cr>", 1, 02, 02, 00,e1,00,00, 00,00,00,00 ; connect at 57600 with PROC.
HKR, Responses, "33<cr>", 1, 02, 02, 00,c2,01,00, 00,00,00,00 ; connect at 115200 with PROC.
...
HKR, Responses, "<cr><lf>CONNECT 57600/V.42bis<cr><lf>",  1, 02, 03, 00,e1,00,00, 00,00,00,00
HKR, Responses, "<cr><lf>CONNECT 115200/V.42bis<cr><lf>", 1, 02, 03, 00,c2,01,00, 00,00,00,00
HKR, Responses, "<cr><lf>CONNECT 57600/PIAFS/V.42bis<cr><lf>",  1, 02, 03, 00,e1,00,00, 00,00,00,00
HKR, Responses, "<cr><lf>CONNECT 115200/PIAFS/V.42bis<cr><lf>", 1, 02, 03, 00,c2,01,00, 00,00,00,00
